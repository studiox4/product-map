...
export async function truncateAll(): Promise<void> {
  await getPool().query(
    'truncate table comments, votes, activity, feature_collaborators, uploads, documents, idea_votes, ideas, evidence, decisions, feature_dependencies, share_tokens, features, releases, objectives, products, templates, users cascade',
  );
}
