...
export function DescriptionBlock({ feature }: { feature: FeatureWithDocs }) {
  ...
  return (
    <section className="rounded-2xl bg-panel p-6" aria-label="Description">
      ...
      <div className="mt-3">
        {editing ? (
          <Textarea
            ...
            className="min-h-32 rounded-xl border-transparent bg-surface text-sm leading-6 focus-visible:ring-2"
          />
        ) : feature.descriptionMd ? (
          ...
          <button
            ...
            className="w-full rounded-xl border border-dashed border-line-dash px-3 py-6 text-center text-sm text-muted-ink transition-colors duration-150 ease-out hover:bg-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
            Add a description…
          </button>
        )}
