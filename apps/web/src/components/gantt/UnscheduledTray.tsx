...
function TrayChip({
  ...
  return (
    <button
      ...
      className={`inline-flex touch-none select-none items-center gap-2 rounded-full border border-transparent bg-surface px-3.5 py-1.5 text-sm text-body-ink shadow-sm-card transition-all duration-150 ease-out hover:-translate-y-px hover:shadow-card focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 ${
